...
public class PlayerAttack2State : CharacterState
{
    public PlayerAttack2State(StateMachine stateMachine, CharacterBaseController controller) : base(stateMachine, controller) { }
